...
ActiveRecord::Schema.define(version: 2021_12_09_024012) do
  ...
  create_table "phone_suppliers", force: :cascade do |t|
    t.string "telefono"
    t.bigint "supplier_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["supplier_id"], name: "index_phone_suppliers_on_supplier_id"
  end
  ...
  add_foreign_key "documents", "expenses"
  ...
  add_foreign_key "phone_suppliers", "suppliers"
